    ...
    useEffect(() => {
        ...
        fetch(`/api/user/${userId}`)
            ...
            .then(data => {
                ...
                // Simple status logic
                if (data.Credit_Score >= 750) setCreditStatus("Excellent");
                else if (data.Credit_Score >= 700) setCreditStatus("Good");
                else if (data.Credit_Score >= 650) setCreditStatus("Fair");
                ...
                <div className="bg-white rounded-2xl shadow p-8 mt-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="border rounded-xl p-6 bg-white flex flex-col justify-between">
                            ...
                            <p className="text-gray-500 mb-4">Payment history is the most important factor in your credit score.</p>
                        ...
                        <div className="border rounded-xl p-6 bg-white flex flex-col justify-between">
                            ...
                            <p className="text-gray-500 mb-4">Try to use less than 30% of your available credit limit.</p>
                        ...
                        <div className="border rounded-xl p-6 bg-white flex flex-col justify-between">
                            ...
                            <p className="text-gray-500 mb-4">Review your credit report regularly for errors and discrepancies.</p>
